...
public:
  ...
  : Node("NDTLocalizer")
  {
    sub_0_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "VoxelGridDownsampler", 1,
      std::bind(&NDTLocalizer::input_callback_0, this, _1));
    sub_1_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "PointCloudMapLoader", 1,
      std::bind(&NDTLocalizer::input_callback_1, this, _1));
    publisher_ = this->create_publisher<reference_interfaces::msg::Message4kb>("NDTLocalizer", 1);
  }
