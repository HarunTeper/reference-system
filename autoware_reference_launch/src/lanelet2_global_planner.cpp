...
class Lanelet2GlobalPlanner : public rclcpp::Node
{
public:
  ...
  : Node("Lanelet2GlobalPlanner")
  {
    sub_0_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "Visualizer", 1,
      std::bind(&Lanelet2GlobalPlanner::input_callback_0, this, _1));
    sub_1_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "NDTLocalizer", 1,
      std::bind(&Lanelet2GlobalPlanner::input_callback_1, this, _1));
    publisher_ = this->create_publisher<reference_interfaces::msg::Message4kb>("Lanelet2GlobalPlanner", 1);
  }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<Lanelet2GlobalPlanner>());
  rclcpp::shutdown();
  return 0;
}
