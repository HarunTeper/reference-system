...
class VehicleDBWSystem : public rclcpp::Node
{
public:
  VehicleDBWSystem()
  : Node("VehicleDBWSystem")
  {
    subscription_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "VehicleInterface", 1,
      std::bind(&VehicleDBWSystem::sub_callback, this, _1));
  }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<VehicleDBWSystem>());
  rclcpp::shutdown();
  return 0;
}
