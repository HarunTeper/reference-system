...
public:
  ...
  : Node("LanePlanner")
  {
    subscription_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "Lanelet2MapLoader", 1,
      std::bind(&LanePlanner::sub_callback, this, _1));
    publisher_ = this->create_publisher<reference_interfaces::msg::Message4kb>("LanePlanner", 1);
  }
...
int main(int argc, char * argv[])
{
  ...
  rclcpp::spin(std::make_shared<LanePlanner>());
  rclcpp::shutdown();
  return 0;
}
