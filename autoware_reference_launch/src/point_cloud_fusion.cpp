...
public:
  ...
  : Node("PointCloudFusion")
  {
    sub_0_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "PointsTransformerFront", 1,
      std::bind(&PointCloudFusion::input_callback_0, this, _1));
    sub_1_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "PointsTransformerRear", 1,
      std::bind(&PointCloudFusion::input_callback_1, this, _1));
    publisher_ = this->create_publisher<reference_interfaces::msg::Message4kb>("PointCloudFusion", 1);
  }
