...
public:
  ...
  : Node("VehicleInterface")
  {
    sub_0_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "MPCController", 1,
      std::bind(&VehicleInterface::input_callback_0, this, _1));
    sub_1_ = this->create_subscription<reference_interfaces::msg::Message4kb>(
      "BehaviorPlanner", 1,
      std::bind(&VehicleInterface::input_callback_1, this, _1));
    publisher_ = this->create_publisher<reference_interfaces::msg::Message4kb>("VehicleInterface", 1);
  }
